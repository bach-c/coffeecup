...
skeleton = function(data) {
  var __cc, cede, coffeescript, comment, doctype, h, ie, stylus, tag, text;
  if (data == null) {
    data = {};
  }
  if (data.format == null) {
  ...
  __cc = {
    ...
    render_idclass: function(str) {
      var c, classes, i, id, idx, j, l, len, len1, ref;
      classes = [];
      ref = str.split('.');
  ...
  tag = function() {
    var a, args, attrs, contents, first, idclass, inline, j, len, name;
